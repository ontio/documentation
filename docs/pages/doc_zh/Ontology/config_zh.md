...
DBFT配置文件为[`config-dbft.json`](https://github.com/ontio/ontology/blob/master/docs/specifications/config-dbft.json)，如下：
...
VBFT是目前ontology的默认共识机制，配置文件为[`config-vbft.json`](https://github.com/ontio/ontology/blob/master/docs/specifications/config-vbft.json)，如下：
