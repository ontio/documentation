...
DBFT配置文件为[`https://github.com/ontio/ontology/blob/master/docs/specifications/config-dbft.json`](config-dbft.json)，如下：
...
VBFT是目前ontology的默认共识机制，配置文件为[`https://github.com/ontio/ontology/blob/master/docs/specifications/config-vbft.json`](config-vbft.json)，如下：
