...
* [Punica Python CLI](https://github.com/punicasuite/punica-python) 和 [Punica TypeScript CLI](https://github.com/punicasuite/punica-ts) - 作为命令行工具，支持编译、部署、调用和测试功能，能够让开发者便捷地使用本体智能合约。
* [Punica boxes](https://punica.ont.io/boxes/) - 提供多款dApp模板和应用案例。
* [Solo-chain](https://github.com/punicasuite/solo-chain/releases) - 本体的一键式（私有）区块链。 
...
* Solo-chain方便用户实时查看链上数据，比在测试网或搭建本地网效率提高50%以上；
