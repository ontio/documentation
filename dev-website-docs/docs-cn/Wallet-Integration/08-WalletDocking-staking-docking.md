...
> 当前支持用户授权质押的钱包：[Owallet](https://github.com/ontio/OWallet/releases)
 ...
 ```polaris``` 测试节点共识周期是3000个块：
* 公钥是 ```021844159f97d81da71da52f84e8451ee573c83b296ff2446387b292e44fba5c98``` 的共识节点接受质押，最多100000个 
* 公钥是 ```029d7aa6e45ce0a9062d671c2bfb3ed06ad9353b6a0f10946c199781111d98156d``` 的候选节点接受质押，最多100000个 
